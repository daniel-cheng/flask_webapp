...
#import httplib2a
httplib2a = imp.load_source('module.httplib2', '~c:/users/potatos/github/flask_webapp/flask/lib/site-packages/httplib2')
...
http = credentials.authorize(httplib2a.Http())###########
